        ...
        <div className='supply_bg_img'>
            <div>
                <Container className='custom_container py_startimgsupply'>
                    <h3 className='ff_jakarta fw-bold fs_52 text-white text-center'>170k Total Starting Supply</h3>
                    <p className='ff_raleway fw-medium fs_16 text-white text-center pb-5'>Initial BONDing Offering (IBO)* Phases</p>
